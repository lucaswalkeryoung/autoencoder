...
class Decoder(Network):
    ...
    def __init__(self):
        ...
        self.conv1 = networks.ConvTranspose2d(16, 16, kernel_size=3, stride=1, padding=1)
        self.norm1 = networks.BatchNorm2d(16)
        self.conv2 = networks.ConvTranspose2d(16, 16, kernel_size=3, stride=1, padding=1)
        self.norm2 = networks.BatchNorm2d(16)
        self.conv3 = networks.ConvTranspose2d(16, 16, kernel_size=3, stride=1, padding=1)
        self.norm3 = networks.BatchNorm2d(16)
        self.conv4 = networks.ConvTranspose2d(16,  3, kernel_size=3, stride=1, padding=1)
